<section class="grid md:grid-cols-[1fr_240px] gap-6 p-6 max-w-6xl mx-auto">
    ...
    <div class="w-full">
        <x-breadcrumbs title="{{ __('Advertising Packages') }}" :links="[['title' => 'Settings', 'slug' => '/settings']]" />
    ...
    <section>
        <div class="p-4 bg-white rounded-xl border">
            <x-icon-megaphone class="h-10 w-auto mb-4" />
            <h1 class="text-xl font-bold mb-4">{{ __('Advertising Packages') }}</h1>
